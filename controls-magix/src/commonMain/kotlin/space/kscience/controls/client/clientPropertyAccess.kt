...
public suspend fun <T> DeviceClient.write(propertySpec: DevicePropertySpec<T>, value: T) {
    writeProperty(propertySpec.name, propertySpec.converter.convert(value))
}

public fun <T> DeviceClient.writeAsync(propertySpec: DevicePropertySpec<T>, value: T): Job = launch {
