...
- **Specification Safety**: When used with `DeviceSpec` and `SpecificDevice` (see [DeviceSpec](deviceSpec.md)), it provides compile-time safety and specification-bound extensions.
